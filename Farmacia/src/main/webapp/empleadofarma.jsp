...
<body>
	<div class="container bg-light rounded border border-success" style="--bs-bg-opacity: .8;">
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="frmEmpleados" method="post"
							action="ServletEmpleadoFa?accion=insertar">
							<div class="form-group">
								<label for="exampleInputEmail1" class="form-label">Código</label>
								<input type="text" class="form-control" name="codigo" value="0"
									id="id-codigo" readonly>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="exampleInputEmail1" class="form-label">Tipo
									Empleado</label> <select class="form-select" name="tipo" id="id-tipo">
									<option value="" selected>Seleccione Tipo Empleado</option>
								</select>
							</div>
							<div class="mb-2"> 
							<label for="exampleInputEmail1" class="form-label">Fotografia de empleado</label>
								<input class="form-control" type="file" id="fileProducto"
									accept="image/png,image/jpg,image/jpeg"
									onchange="mostrarImagen(this)" name="fotoemp" value="" />
							</div>
		...
		<form id="form-eliminar" method="post"
			action="ServletEmpleadoFa?accion=eliminar">
