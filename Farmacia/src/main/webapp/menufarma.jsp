	...
	<nav class="navbar navbar-dark bg-dark fixed-top">
	  <div class="container-fluid"> 
	    ...
	    <form class="d-flex" action="ServletUsuarioFa?accion=CERRARSESION" method="post">
	        <button class="btn btn-danger desaparecer" type="submit">Cerrar Sesión</button>
	    </form>
	    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
	      ...
	      <div class="offcanvas-body">
	      	<h3>Bienvenid@, ${sessionScope.DATOS}</h3>
	      	 <img class="rounded-5 align-items-center" src="${sessionScope.IMAGEN}" alt="Imagen del usuario" /> <!-- Mostrar la imagen del usuario -->
